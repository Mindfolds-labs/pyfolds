...
1. Execute um prompt de auditoria (ex: `PROMPT_AUDITORIA.md`)
2. A IA gera o relatório completo
3. Salve o arquivo nesta pasta como `ISSUE-XXX-descricao.md`
4. Revise e aprove antes de iniciar a execução

[Link para a Issue ou o corpo da Issue em Markdown]

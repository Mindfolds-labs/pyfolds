---
id: "ISSUE-004"
titulo: "Plano 2 — Sanear links e navegação documental"
prioridade: "Alta"
area: "Documentação/Qualidade"
responsavel: "Codex"
...
## Objetivo
Corrigir links quebrados e garantir navegação consistente entre ADR, arquitetura, prompts e HUB.
...
## PROMPT:EXECUTAR
```yaml
objetivo: "Corrigir links quebrados e garantir navegação consistente entre ADR, arquitetura, prompts e HUB."
issue_id: "ISSUE-004"
prioridade: "Alta"
area: "Documentação/Qualidade"
```

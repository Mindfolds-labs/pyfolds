...
class PyFoldsLogger:
    ...
    def setup(
        ...
        """Configura (ou reconfigura) logging global."""
        ...
        # Remove/fecha handlers previamente anexados.
        ...
        logging.info("✅ Logging configurado - nível: %s", logging.getLevelName(level))
